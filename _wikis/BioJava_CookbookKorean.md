...
permalink: wikis/BioJava%3ACookbookKorean
---
...
-   [BioJava는 어디서 다운로드해서 설치할 수
    있나요](/wikis/BioJavaKorean:GetStarted "wikilink")?

### 알파벳과 심볼

-   [어떻게 DNA, RNA 또는 단백질 알파벳을 얻을 수
    있나요](/wikis/BioJavaKorean:Cookbook:Alphabets "wikilink")?
-   [어떻게 커스텀 심볼로 부터 커스텀 알파벳을 만들 수
    있나요](/wikis/BioJavaKorean:Cookbook:Alphabets:Custom "wikilink")?
-   [어떻게 코돈 알파벳과 같은 CrossProductAlphabet을 만들 수
    있나요](/wikis/BioJava:Cookbook:Alphabets:CrossProduct "wikilink")?
-   [어떻게 컴포넌트 심볼의 CrossProduct 알파벳으로부터 분해 할 수
    있나요](/wikis/BioJava:Cookbook:Alphabets:Component "wikilink")?
-   [어떻게 두 알파벳 또는 심볼이 같다고 말할 수
    있나요](/wikis/BioJava:Cookbook:Alphabets:Cononical "wikilink")?
-   [어떻게 Y나 R과 같이 애매한 심볼을 만들 수
    있나요](/wikis/BioJava:Cookbook:Alphabets:Ambiguous "wikilink")?

### 기본적인 서열 조작하기

-   [어떻게 하면 문자로 부터 서열 객체를 작성하거나 서열 객체를 문자로
    되돌릴 수 있나요](/wikis/BioJava:Cookbook:Sequence "wikilink")?
-   [어떻게 서열 객체의 일부분을 가져올 수
    있나요](/wikis/BioJava:Cookbook:Sequence:SubSequence "wikilink")?
-   [어떻게 DNA 서열을 RNA 서열로 전사할 수
    있나요](/wikis/BioJava:Cookbook:Sequence:Transcribe "wikilink")?
-   [어떻게 DNA나 RNA 서열의 reverse complement를 만들 수
    있나요](/wikis/BioJava:Cookbook:Sequence:Reverse "wikilink")?
...
-   [어떻게 Sequence나 SymbolList를 편집할 수
    있나요](/wikis/BioJava:Cookbook:Sequence:Edit "wikilink")?
...
-   [어떻게 DNA, RNA, SymbolList를 단백질로 번역할 수
    있나요](/wikis/BioJava:Cookbook:Translation "wikilink")?
-   [어떻게 싱글 코돈을 싱글 아미노산으로 번역할 수
    있나요](/wikis/BioJava:Cookbook:Translation:Single "wikilink")?
-   [어떻게 비 표준의 번역 테이블을 사용할 수
    있나요](/wikis/BioJava:Cookbook:Translation:NonStandart "wikilink")?
...
-   [어떻게 서열을 Fasta 형식으로 만들 수
    있나요](/wikis/BioJava:Cookbook:SeqIO:WriteInFasta "wikilink")?
-   [어떻게 Fasta 파일을 읽을 수
    있나요](/wikis/BioJava:Cookbook:SeqIO:ReadFasta "wikilink")?
-   [어떻게 GenBank/EMBL/SwissProt 파일을 읽을 수
    있나요](/wikis/BioJava:Cookbook:SeqIO:ReadGES "wikilink")?
-   [어떻게 Biojavax 확장을 가지고 서열 파일을 읽을 수
    있나요](/wikis/BioJava:Cookbook:SeqIO:ReadGESBiojavax "wikilink")?
-   [How do I extract GenBank/EMBL/Swissprot sequences and write them as
    Fasta](/wikis/BioJava:Cookbook:SeqIO:GBtoFasta "wikilink")?
...
-   [어떻게 BLAST 파서를 설정
    하나요](/wikis/BioJava:CookBook:Blast:Parser "wikilink")?
-   [어떻게 FASTA 파서를 설정
    하나요](/wikis/BioJava:CookBook:Fasta:Parser "wikilink")?
-   [어떻게 파싱된 결과로 부터 정보를 추출
    하나요](/wikis/BioJava:CookBook:Blast:Extract "wikilink")?
-   [어떻게 큰 파일을 파싱할 수 있나요;또는 어떻게 맞춤
    SearchContentHandler를 만들 수
    있나요](/wikis/BioJava:CookBook:Blast:Echo "wikilink")?
-   [어떻게 XML 형태의 BLAST 결과를 HTML 페이지로 만들 수
    있나요](/wikis/BioJava:CookBook:Blast:XML "wikilink")?
...
-   [어떻게 PostgreSQL을 가지고 BioSQL을
    설정하나요](/wikis/BioJava:CookBook:BioSQL:SetupPostGre "wikilink")?
    ([[User:David|David Huen]로 부터])
-   [어떻게 오라클을 가지고 BioSQL을
    설정하나요](/wikis/BioJava:CookBook:BioSQL:SetupOracle "wikilink")?
...
-   [어떻게 BioJava를 가지고 유전자 알고리즘을 만들 수
    있나요](/wikis/BioJava:CookBook:GA "wikilink")?

### 단백질 구조

-   [어떻게 PDB 파일을 읽을 수
    있나요](/wikis/BioJava:CookBook:PDB:read "wikilink")?
-   [어떻게 .mmcif 파일을 읽을 수
    있나요](/wikis/BioJava:CookBook:PDB:mmcif "wikilink")?
-   [어떻게 구조 파일의 원자에 접근할 수
    있나요](/wikis/BioJava:CookBook:PDB:atoms "wikilink")?
-   [어떻게 원자를 계산할 수
    있나요](/wikis/BioJava:CookBook:PDB:atomsCalc "wikilink")?
-   [어떻게 PDB 파일의 헤더 정보에 접근할 수
    있나요](/wikis/BioJava:CookBook:PDB:header "wikilink")?
...
-   [How can I calculate a structure
    superimposition?](/wikis/BioJava:CookBook:PDB:align "wikilink")
-   [How can I use a simple GUI to calculate a
    superimposition?](/wikis/BioJava:CookBook:PDB:alignGUI "wikilink")
-   [어떻게 Jmol과 사용할 수
    있나요](/wikis/BioJava:CookBook:PDB:Jmol "wikilink")?
-   [어떻게 데이터베이스로 부터 직렬화 할 수
    있나요](/wikis/BioJava:CookBook:PDB:hibernate "wikilink")?

### 온톨로지

-   [어떻게 OBO 파일을 파싱할 수
    있나요](/wikis/BioJava:CookBook:OBO:parse "wikilink")?
