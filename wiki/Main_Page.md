...
-   [http://www.biojava.org/docs/api/index.html API
    docs](http://www.biojava.org/docs/api/index.html API docs "wikilink")
    (BioJava version 1.3)
-   [http://www.biojava.org/docs/api14/index.html API
    docs](http://www.biojava.org/docs/api14/index.html API docs "wikilink")
    (BioJava version 1.4)
